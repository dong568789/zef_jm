...
<form action="<{'admin'|url nofilter}>/<{block "name"}><{/block}>" method="GET" class="form-bordered form-horizontal">
	<div class="form-group col-sm-4">
		<label class="col-md-3 control-label" for="nickname">姓名</label>
		<div class="col-md-9">
			<div class="input-group">
				<input type="text" id="nickname" name="f[nickname][lk]" class="form-control" placeholder="请输入关键词..."
					   value="<{$_filters.nickname.lk}>">
	...
	<div class="form-group col-sm-4">
		<label class="col-md-3 control-label" for="mobile">电话</label>
		<div class="col-md-9">
			<div class="input-group">
				<input type="text" id="mobile" name="f[mobile][lk]" class="form-control" placeholder="请输入关键词..." value="<{$_filters.mobile.lk}>">
				<span class="input-group-addon"><i class="gi gi-user"></i></span>
			</div>
		</div>
	</div>
	<div class="form-group col-sm-4">
		<label class="col-md-3 control-label" for="created_at-min">时间</label>
		<div class="col-md-9">

...
<script>
    export default {
        ...
        methods: {
             ...
             */
            getClients() {
                this.$http.get('http://crm.kmayi.cn/oauth/clients')
                        .then(response => {
            ...
            store() {
                this.persistClient(
                    'post', 'http://crm.kmayi.cn/oauth/clients',
            ...
            update() {
                this.persistClient(
                    'put', 'http://crm.kmayi.cn/oauth/clients/' + this.editForm.id,
             ...
             */
            destroy(client) {
                this.$http.delete('http://crm.kmayi.cn/oauth/clients/' + client.id)
                        .then(response => {
                            this.getClients();
                        });
            }

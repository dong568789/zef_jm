<template>
	...
	<input type="hidden" name="_token" v-model="csrf">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="hidden" id="cover_id" name="cover_id" v-model="node.cover_id_item" class="form-control">
            </div>
        </div>
        <div class="form-group">
            <label for="title" class="col-sm-2 control-label">排序</label>
            <div class="col-sm-10">
                <input type="text" id="order_index" name="order_index" v-model="node.order_index" class="form-control">
            </div>
        </div>

        <div class="form-group">
            <label for="title" class="col-sm-2 control-label">seo标题</label>
            <div class="col-sm-10">
                <input id="seo_title" name="seo_title" v-model="node.seo_title" class="form-control"
                       placeholder="请输入标题">
            </div>
        </div>

        <div class="form-group">
            <label for="title" class="col-sm-2 control-label">seo关键字</label>
            <div class="col-sm-10">
                <textarea id="seo_keyword" name="seo_keyword" v-model="node.seo_keyword" class="form-control"
                          placeholder="请输入关键字" rows="10"></textarea>
            </div>
        </div>
        <div class="form-group">
            <label for="title" class="col-sm-2 control-label">seo描述</label>
            <div class="col-sm-10">
                <textarea id="seo_description" name="seo_description" v-model="node.seo_description" class="form-control"
                          placeholder="请输入描述" rows="10"></textarea>
            </div>
        </div>
		<div class="form-group">
